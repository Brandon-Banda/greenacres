    ...
    <div className="main">
      ...
      <div className="contract-section">
        <p>
          ...
          accommodations to function properly. The market operates from 10 am to
          4 pm; location being 1047 CR 465, Alice, TX. This is a one-day market.
          ...
          Area. Please do not park in the areas across the overhead doors as
          this area is for shoppers. Please conduct your sales within your
          designated vendor space. Do not walk around the market trying to sell
          your items. The same applies to handing out food samples. Do so only
          from your vendor spaces. Please remember to click “Going” on our
          Facebook Event post and also Share the post. Also, while at the
          market, remember to “Check In” on social media, share your photos and
          invite your family and friends. We want you all to have a successful
          experience!
        </p>
        <p>
          Vendor Payment Disclaimer: Please note that if cancellation by vendor
          occurs for ANY reason after payment is submitted, we will NOT refund
          your payment, nor will it be used as credit towards future markets. We
          ...
          a refund will NOT be issued. Instead, a rain check will be offered to
          vendors for future events. If vendor declines or cannot attend new
          date for market, a refund will NOT be provided, and rain check will be
        ...
        <p>
          ...
          Zelle: 361-533-2590 CashApp: $AlvaZambranoGAM PayPal: aiz72 @yahoo.com
        </p>
        <p>{data}</p>
      </div>
    </div>
